...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("UPDATE reservations SET full_name = ?, contact_number = ?, address = ?, booking_date = ?, num_adults = ?, num_kids = ?, room = ?, swimming_type = ?, cottage = ?, shift = ?, others = ?, status = ? WHERE id = ?");
        ...
        if ($stmt->execute()) {
            ...
            log_activity($_SESSION['user_id'], 'Update Reservation', "Updated reservation #$reservation_id");
            ...
            $errors[] = "Failed to update reservation. Error: " . $stmt->error;
        }
...
<div class="content-container">
    <div style="margin-bottom: 30px;">
        <a href="reservation_view.php?id=<?php echo $reservation_id; ?>" class="btn btn-secondary">← Back to Details</a>
    </div>

    <div class="form-container">
        <h1>Edit Reservation: <?php echo htmlspecialchars($reservation['booking_id']); ?></h1>
        ...
        <form method="POST" action="" class="edit-form">
            ...
            <div class="form-actions">
                ...
                <a href="reservation_view.php?id=<?php echo $reservation_id; ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
